...
**Реализация:** handleChangeModeCommand в changeModeHandler.ts
...
2. **Отправка выбора** — показывает inline кнопки с доступными режимами:
   - 📝 "Тексты" → callback_data: "change_mode:text"
   - 🎨 "Картинки" → callback_data: "change_mode:image"
